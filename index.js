...
//  let arr2 = arr.map((curElm,index,arr) => curElm * 2).filter((curElem) => curElem > 10 ).reduce((accumulator, curElem) => {
...
// alert("do u want to vsit previous history");
